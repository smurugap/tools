...
class ServiceChain(object):
    def __init__(self, base_obj, user='admin', password='contrail123',
                 tenant='admin', api_server_host='127.0.0.1',
                 api_server_port='8082', auth_host='127.0.0.1', auth_token=None):
        self.obj = base_obj
    ...
    def create_policy(self, name, src_vn, dst_vn, direction='<>',
        ...
        self.obj.update_network(src_vn, {'contrail:policys': [policy.fq_name]})
        self.obj.update_network(dst_vn, {'contrail:policys': [policy.fq_name]})
